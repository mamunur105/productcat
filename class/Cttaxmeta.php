...
class Cttaxmeta {
    ...
    */
    public function init() {
        ...
        add_filter( 'manage_edit-category_columns',[$this,'manage_my_category_columns'],9,2);
        add_filter( 'manage_category_custom_column',[$this,'manage_category_custom_fields'], 10,3);
    }

    function manage_my_category_columns($columns){
         array_splice($columns, 1, 0, array('image'=>'Image'));
         return $columns;
    }
